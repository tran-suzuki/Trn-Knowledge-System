...
return [
    ...
    'custom' => [
        'email' => [
            'min' => 'E-Mailは５文字以上、255文字以内で入力してください。',
            'max' => 'E-Mailは５文字以上、255文字以内で入力してください。',
            'regex' => 'メールアドレスは半角英数、ハイフン（-）、アンダーバー（_）、ドット（.）、アットマーク（＠）のみ入力可能です。',
            'email' => 'メールアドレス形式で入力してください。'
        ],
        'password' => [
            'min'      => 'パスワードは6文字以上、255文字以内で入力してください。',
            'max'      => 'パスワードは6文字以上、255文字以内で入力してください。',
